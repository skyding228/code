...
!function (e, t) {
    ...
    function A(e) {
        if (!(e = v(e)[0])) return 0;
        var n, i, o, a, f, d, h, l = e.tagName.toLowerCase(), w = e.style, u = 1, c = 1;
    ...
    function B(e, t) {
        ...
        t = t || A(e) + 1;
        var r = d.getComputedStyle(e), i = r.strokeDasharray || "", o = n(r.strokeDashoffset), s = i.indexOf(",");
    ...
    var a, v, d, h, l, b = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
        ...
        }(window ? window.location.host : ""), g = {
            version: "3.6.0", name: "drawSVG", register: function register(e) {
                a = e, C()
                ...
                }(r, f, (i = B(e, f))[0]), this._length = m(f), this._dash = m(i[1] - i[0]), this._offset = m(-i[0]), this._dashPT = this.add(this, "_dash", this._dash, m(s[1] - s[0])), this._offsetPT = this.add(this, "_offset", this._offset, m(-s[0])), h && (a = d.getComputedStyle(e)).strokeLinecap !== a.strokeLinejoin && (s = n(a.strokeMiterlimit), this.add(e.style, "strokeMiterlimit", s, s + .01)), this._live = t(e) || ~(r + "").indexOf("live"), this._props.push("drawSVG"), c
            }, render: function render(e, t) {
                var n, r, i, o, s = t._pt, a = t._style;
                if (s) {
                    for (t._live && (n = A(t._target)) !== t._length && (r = n / t._length, t._length = n, t._offsetPT.s *= r, t._offsetPT.c *= r, t._dashPT ? (t._dashPT.s *= r, t._dashPT.c *= r) : t._dash *= r); s;) s.r(e, s.d), s = s._next;
                    i = t._dash || e && 1 !== e && 1e-4 || 0, n = t._length - i + .1, o = t._offset, i && o && i + Math.abs(o % t._length) > t._length - .2 && (o += o < 0 ? .1 : -.1) && (n += .1), a.strokeDashoffset = i ? o : o + .001, a.strokeDasharray = n < .2 ? "none" : i ? i + "px," + n + "px" : "0px, 999999px"
                }
            }, getLength: A, getPosition: B
        };
